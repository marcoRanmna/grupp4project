...
!function (e) {
    ...
    i = 0, (r = function (e, t) {
        ...
        if (a.defaults = {
            ...
            default_class: d(e)[0].classList.value, validParts: /dd?|DD?|mm?|MM?|yy(?:yy)?/g, dates: {
                en: {
                    ...
                    noEventForToday: "No data",
                    noEventForThisDay: "No data",
        ...
        a.startingDay = null, a.monthLength = null, a.windowW = d(window).width(), a.$current = {
            ...
            activeMonthEl: null,
            activeYearEl: null
        }, a.$breakpoints = {tablet: 768, mobile: 425}, a.$UI = {
            hasSidebar: !0,
            hasEvent: !0
        ...
        var t = e.replace(this.initials.validParts, "\0").split("\0"), e = e.match(this.initials.validParts);
        ...
        for (var a = this, n = 0, i = 0; i < a.options.calendarEvents.length; i++) if (a.options.calendarEvents[i].date instanceof Array) for (var o = a.getBetweenDates(a.options.calendarEvents[i].date), r = 0; r < o.length; r++) e === o[r] && t === a.options.calendarEvents[i].type && n++; else e === a.options.calendarEvents[i].date && t === a.options.calendarEvents[i].type && n++;
        return 0 < n
    }, r.prototype.setTheme = function (e) {
        var t = this, a = t.options.theme;
        ...
        if (0 < n.children().length && n.empty(), t.options.calendarEvents) for (var i = 0; i < t.options.calendarEvents.length; i++) {
        ...
        var a, n, i = this, e = t.date, o = i.stringCheck(t.type);
        ...
        var t = this, a = e.date, n = t.stringCheck(e.type);
        if (a instanceof Array) for (var i = t.getBetweenDates(a), o = 0; o < i.length; o++) r(i[o]); else r(a);
        ...
        var t = this, a = d(e.target).closest(".event-container"), e = d(a).data("eventIndex").toString(),
            a = t.options.calendarEvents.map(function (e) {
                return e.id.toString()
            }).indexOf(e), e = t.options.calendarEvents[a];
        ...
        var t, a, n, i = this, o = i.$active.date;
        ...
        var t = this, e = e.target === t.$elements.innerEl[0];
        ...
        function t(t) {
            if (t.id || console.log('%c Event named: "' + t.name + "\" doesn't have a unique ID ", "color:white;font-weight:bold;background-color:#e21d1d;"), t.date instanceof Array) for (var e = 0; e < t.date.length; e++) a(t.date[e]) && (t.date[e] = n.formatDate(new Date(t.date[e]), n.options.format)); else a(t.date) && (t.date = n.formatDate(new Date(t.date), n.options.format));
        ...
        if (e instanceof Array) for (var a = 0; a < e.length; a++) t(e[a]); else "object" == typeof e && t(e)
        ...
        if (e instanceof Array) for (var a = 0; a < e.length; a++) t(e[a]); else t(e)
    }, r.prototype.isValidDate = function (e) {
        return new Date(e) && !isNaN(new Date(e).getTime())
    }, d.fn.evoCalendar = function () {
        for (var e, t = this, a = arguments[0], n = Array.prototype.slice.call(arguments, 1), i = t.length, o = 0; o < i; o++) if ("object" == typeof a || void 0 === a ? t[o].evoCalendar = new r(t[o], a) : e = t[o].evoCalendar[a].apply(t[o].evoCalendar, n), void 0 !== e) return e;
        return t
    }
});